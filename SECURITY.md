...
The current release is **0.0.14**, matching `MARKETING_VERSION` in the Xcode project and the version badge in [README.md](README.md). There is no documented support window for older versions; treat the latest release as the supported one.
...
- Steps to reproduce, with the app version (for example 0.0.14) and macOS version.
