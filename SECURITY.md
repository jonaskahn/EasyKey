...
The current release is **0.0.8** (the `v0.0.8` tag, matching `MARKETING_VERSION`). There is no documented support window for older versions; treat the latest release as the supported one.
